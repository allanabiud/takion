...
class ArcSearchArgs {
  const ArcSearchArgs({required this.query, required this.page});
...
final arcSearchResultsProvider = FutureProvider.autoDispose
    .family<ArcListPage, ArcSearchArgs>((ref, args) async {
