...
@RoutePage()
class ArcIssuesScreen extends ConsumerStatefulWidget {
  const ArcIssuesScreen({super.key, @pathParam required this.arcId});

  final int arcId;

  @override
  ConsumerState<ArcIssuesScreen> createState() => _ArcIssuesScreenState();
}

class _ArcIssuesScreenState extends ConsumerState<ArcIssuesScreen> {
  int _page = 1;
  ArcIssueListPage? _lastPage;
  int _totalPages = 1;
