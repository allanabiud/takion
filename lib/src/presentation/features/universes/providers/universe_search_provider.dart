...
class UniverseSearchArgs {
  const UniverseSearchArgs({required this.query, required this.page});
  ...
  bool operator ==(Object other) {
    ...
    return other is UniverseSearchArgs &&
        other.query == query &&
        other.page == page;
  }
...
final universeSearchResultsProvider = FutureProvider.autoDispose
    .family<UniverseListPage, UniverseSearchArgs>((ref, args) async {
