...
enum _UniverseMenuAction { share, openInBrowser }
...
class _UniverseDetailsScreenState extends ConsumerState<UniverseDetailsScreen> {
  ...
  Future<void> _handleMoreAction(
    _UniverseMenuAction action,
    UniverseDetails details,
  ) async {
    switch (action) {
      case _UniverseMenuAction.share:
        await _shareResourceUrl(details);
      case _UniverseMenuAction.openInBrowser:
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: AppBar(
                        ...
                        elevation: 0,
                        actions: [
                          PopupMenuButton<_UniverseMenuAction>(
                            tooltip: 'More options',
                            onSelected: (action) =>
                                _handleMoreAction(action, details),
                            itemBuilder: (context) => const [
                              PopupMenuItem(
                                value: _UniverseMenuAction.share,
                                child: Text('Share'),
                              ),
                              PopupMenuItem(
                                value: _UniverseMenuAction.openInBrowser,
