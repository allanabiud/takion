...
class CharacterSearchArgs {
  const CharacterSearchArgs({required this.query, required this.page});
  ...
  bool operator ==(Object other) {
    ...
    return other is CharacterSearchArgs &&
        other.query == query &&
        other.page == page;
  }
...
final characterSearchResultsProvider = FutureProvider.autoDispose
    .family<CharacterListPage, CharacterSearchArgs>((ref, args) async {
