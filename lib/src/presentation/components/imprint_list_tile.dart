...
class ImprintListTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final details = ref.watch(imprintDetailsProvider(imprintId));
    final detailsImage = details.whenOrNull(data: (d) => d.image);
    final effectiveImageUrl = imageUrl ?? detailsImage;
    final detailsPublisher = details.whenOrNull(data: (d) => d.publisher?.name);
    final effectiveSubtitle = subtitle ?? detailsPublisher;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (effectiveSubtitle != null &&
                          effectiveSubtitle.trim().isNotEmpty) ...[
