...
final becauseYouPulledIssuesProvider =
    FutureProvider.autoDispose<List<IssueList>>((ref) async {
      ...
      final candidates = weeklyIssues.where((issue) {
        ...
        if (pulledIssueIds.contains(issueId) ||
            ownedIssueIds.contains(issueId)) {
          return false;
        }
        return true;
      }).toList();
