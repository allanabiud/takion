...
class MetronCachePolicies {
  ...
  static const searchResults = CachePolicy(ttl: Duration(hours: 6));
  static const issueDetails = CachePolicy(ttl: Duration(hours: 24));
  static const seriesDetails = CachePolicy(ttl: Duration(hours: 48));
  static const seriesIssueList = CachePolicy(ttl: Duration(hours: 12));
  static const characterDetails = CachePolicy(ttl: Duration(hours: 48));
  static const characterIssueList = CachePolicy(ttl: Duration(hours: 12));
  static const creatorSearchResults = CachePolicy(ttl: Duration(hours: 6));
  static const creatorDetails = CachePolicy(ttl: Duration(hours: 48));
  static const universeSearchResults = CachePolicy(ttl: Duration(hours: 6));
  ...
  static const teamSearchResults = CachePolicy(ttl: Duration(hours: 6));
  static const teamDetails = CachePolicy(ttl: Duration(hours: 48));
  static const arcSearchResults = CachePolicy(ttl: Duration(hours: 6));
  static const imprintSearchResults = CachePolicy(ttl: Duration(hours: 6));
  static const publisherSearchResults = CachePolicy(ttl: Duration(hours: 6));
  static const publisherSeriesList = CachePolicy(ttl: Duration(hours: 12));
  static const arcList = CachePolicy(ttl: Duration(hours: 6));
  static const arcDetails = CachePolicy(ttl: Duration(days: 7));
  static const arcIssueList = CachePolicy(ttl: Duration(hours: 12));
  static const teamIssueList = CachePolicy(ttl: Duration(hours: 12));
  static const characterList = CachePolicy(ttl: Duration(hours: 6));
  static const creatorList = CachePolicy(ttl: Duration(hours: 6));
  static const imprintList = CachePolicy(ttl: Duration(hours: 6));
  static const publisherList = CachePolicy(ttl: Duration(hours: 6));
  static const teamList = CachePolicy(ttl: Duration(hours: 6));
  static const universeList = CachePolicy(ttl: Duration(hours: 6));
  static const readingList = CachePolicy(ttl: Duration(hours: 6));
