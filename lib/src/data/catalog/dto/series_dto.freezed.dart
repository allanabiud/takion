...
mixin _$SeriesDto {
 ...
 int? get id; String? get name; int? get volume;@JsonKey(name: 'year_began') int? get yearBegan;@JsonKey(name: 'publisher_name') String? get publisherName;@JsonKey(name: 'desc') String? get description;@JsonKey(name: 'series') String? get seriesName;
...
@useResult
$Res call({
 int? id, String? name, int? volume,@JsonKey(name: 'year_began') int? yearBegan,@JsonKey(name: 'publisher_name') String? publisherName,@JsonKey(name: 'desc') String? description,@JsonKey(name: 'series') String? seriesName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? name,  int? volume, @JsonKey(name: 'year_began')  int? yearBegan, @JsonKey(name: 'publisher_name')  String? publisherName, @JsonKey(name: 'desc')  String? description, @JsonKey(name: 'series')  String? seriesName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeriesDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? name,  int? volume, @JsonKey(name: 'year_began')  int? yearBegan, @JsonKey(name: 'publisher_name')  String? publisherName, @JsonKey(name: 'desc')  String? description, @JsonKey(name: 'series')  String? seriesName)  $default,) {final _that = this;
switch (_that) {
case _SeriesDto():
return $default(_that.id,_that.name,_that.volume,_that.yearBegan,_that.publisherName,_that.description,_that.seriesName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? name,  int? volume, @JsonKey(name: 'year_began')  int? yearBegan, @JsonKey(name: 'publisher_name')  String? publisherName, @JsonKey(name: 'desc')  String? description, @JsonKey(name: 'series')  String? seriesName)?  $default,) {final _that = this;
switch (_that) {
case _SeriesDto() when $default != null:
return $default(_that.id,_that.name,_that.volume,_that.yearBegan,_that.publisherName,_that.description,_that.seriesName);case _:
  return null;
...
class _SeriesDto extends SeriesDto {
  const _SeriesDto({this.id, this.name, this.volume, @JsonKey(name: 'year_began') this.yearBegan, @JsonKey(name: 'publisher_name') this.publisherName, @JsonKey(name: 'desc') this.description, @JsonKey(name: 'series') this.seriesName}): super._();
...
@override@JsonKey(name: 'publisher_name') final  String? publisherName;
@override@JsonKey(name: 'desc') final  String? description;
@override@JsonKey(name: 'series') final  String? seriesName;
